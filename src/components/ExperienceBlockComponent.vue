...
<template>
    <div
        class="group relative grid pb-1 transition-all sm:grid-cols-9 sm:gap-9 md:gap-4 lg:hover:opacity-100 lg:group-hover/list:opacity-50"
    >
        <div
        ...
        ></div>
        <header
            class="z-10 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-500 sm:col-span-3"
        >
            {{ experience.period }}
        </header>
